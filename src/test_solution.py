...
@pytest.mark.it("Method DELETE /member/<int:id> should return a dictionary with 'done' key")
...
@pytest.mark.it("After deleting the member 3443, calling GET /members should return a list with 4 members")
